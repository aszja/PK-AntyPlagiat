...
public class SourceCodeExtractor {
	...
	public String deleteCommnents(String source)
	{
		while(source.contains("/*"))
		{
			...
			{
				System.out.println("Wystąpil problem z komentarzami - ktorys moglbyc niedomkniety!");
				break;
			}
		}
		...
		while(source.contains("//"))
		{
			...
			{
				System.out.println("Wystąpil problem z jednolinijkowymi komentarzami!");
				break;
			}
		}
	...
	public List<String> getListOfUsedLibraries(String source, String key)
	{
		...
		while(source.contains(key))
		{
			...
			{
				System.out.println("Wystąpil problem podczas generowania listy bibliotek!");
				break;
			}
		}
		////debug
	...
	public Map<String, Integer> createDictioriesOfMethodsAndFields(String source)
	{
		...
		while(source.contains("\""))
		{
			...
			{
				System.out.println("Wystąpil problem z cudzyslowami!");
				break;
			}
		}
		...
		while(source.contains("("))
		{
			...
			{
				System.out.println("Wystąpil problem podczas szukania metod!");
				break;
			}
		}
		...
		while(source.contains("="))
		{
			...
			{
				System.out.println("Wystąpil problem podczas szukania zmiennych!");
				break;
			}
		}
