...
import pl.pk.antyplagiat.algorithms.helpers.DictionaryExtractor;
import pl.pk.antyplagiat.algorithms.helpers.KarpRabinAlgorithm;

public class DocsAlgoritm {

    /* 
     * pkt 2,3,4 z dokumentu analizy
     * metoda jako parametr wejsciowy przyjmuje paragraf, a zwraca liste, w kt�rej znajduja
     * si� percentOdWords% wyrazow najrzadziej i najczesciej wystepujacych
     */
